...
<form action="{{ url('/') }}" method="POST" class="w-3/6 flex flex-col justify-center items-center"> 
    @csrf
  ...
  <button type="button" class=" mt-2 text-white bg-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm w-[20%] py-2.5 text-center me-2 mb-2">Register</button>
</form>
</div>
</body>
</html>
